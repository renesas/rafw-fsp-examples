...
Example:  wifi_tcp_client_twt_ek_ra6w2_ep : TCP Client with DPM and TWT Mode Usage

1. Project Overview:
The  wifi_tcp_client_twt_ek_ra6w2_ep application acts as a TCP client in DPM mode and 
...
which wakes up the ra6w2 every 120000 ms. The TCP client then sends a packet
...
1 x Renesas ra6w2 Mother board
1 x Renesas ra6w2 Module.
