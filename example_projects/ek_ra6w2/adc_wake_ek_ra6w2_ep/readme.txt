...
1. Project Overview:
The example project demonstrates the typical use of the PMGR HAL module APIs using PMGR and ADC modules.
...
﻿6. Press BTN1 to wake device from sleep. Here ADC channel 2 is configured to do sensor wakeup if voltage drops from
   configured level, 0xF00.
