...
typedef enum
{
    ...
    BLE_DI2S_DECL_HDL = 0x0010,
    BLE_DI2S_MFR_NAME_DECL_HDL = 0x0011,
    BLE_DI2S_MFR_NAME_VAL_HDL = 0x0012,
    BLE_DI2S_MODEL_NUM_DECL_HDL = 0x0013,
    BLE_DI2S_MODEL_NUM_VAL_HDL = 0x0014,
    BLE_DI2S_SER_NUM_DECL_HDL = 0x0015,
    BLE_DI2S_SER_NUM_VAL_HDL = 0x0016,
    BLE_DI2S_HW_REV_DECL_HDL = 0x0017,
    BLE_DI2S_HW_REV_VAL_HDL = 0x0018,
    BLE_DI2S_FIRM_REV_DECL_HDL = 0x0019,
    BLE_DI2S_FIRM_REV_VAL_HDL = 0x001A,
    BLE_DI2S_SW_REV_DECL_HDL = 0x001B,
    BLE_DI2S_SW_REV_VAL_HDL = 0x001C,
    BLE_DI2S_SYS_ID_DECL_HDL = 0x001D,
    BLE_DI2S_SYS_ID_VAL_HDL = 0x001E,
    BLE_DI2S_REG_CER_DATA_LIST_DECL_HDL = 0x001F,
    BLE_DI2S_REG_CER_DATA_LIST_VAL_HDL = 0x0020,
    BLE_DI2S_PNP_ID_DECL_HDL = 0x0021,
    BLE_DI2S_PNP_ID_VAL_HDL = 0x0022,
} e_ble_attr_hdl_t;
...
#define BLE_DI2S_MFR_NAME_LEN (100)
#define BLE_DI2S_MODEL_NUM_LEN (100)
#define BLE_DI2S_SER_NUM_LEN (100)
#define BLE_DI2S_HW_REV_LEN (100)
#define BLE_DI2S_FIRM_REV_LEN (100)
#define BLE_DI2S_SW_REV_LEN (100)
#define BLE_DI2S_SYS_ID_LEN (8)
#define BLE_DI2S_REG_CER_DATA_LIST_LEN (100)
#define BLE_DI2S_PNP_ID_LEN (7)
