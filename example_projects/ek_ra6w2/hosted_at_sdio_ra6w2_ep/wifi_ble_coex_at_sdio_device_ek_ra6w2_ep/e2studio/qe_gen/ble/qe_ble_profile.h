...
typedef enum qe_attribute_handle
{
    ...
    QE_ATTRIBUTE_HANDLE_SERVICE_DECL_DI2,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_DI2_MFR_NAME,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_DI2_MFR_NAME,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_DI2_MODEL_NUM,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_DI2_MODEL_NUM,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_DI2_SER_NUM,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_DI2_SER_NUM,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_DI2_HW_REV,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_DI2_HW_REV,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_DI2_FIRM_REV,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_DI2_FIRM_REV,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_DI2_SW_REV,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_DI2_SW_REV,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_DI2_SYS_ID,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_DI2_SYS_ID,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_DI2_REG_CER_DATA_LIST,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_DI2_REG_CER_DATA_LIST,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_DI2_PNP_ID,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_DI2_PNP_ID,
...
#define        QE_BLE_PROFILE_NUMBER_OF_ATTRIBUTES    (0x0023)
