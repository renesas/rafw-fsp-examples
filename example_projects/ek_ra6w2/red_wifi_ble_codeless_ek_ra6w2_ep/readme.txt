...
1. Project Overview:
This is an example for the RA6W2, designed to showcase how to establish a secure AT communication channel using the AT
secure channel key and encrypted AT commands transmitted from the host to the RA6W2. The process begins by generating
...
Connect the USB Debug port on the mother board to the programming PC via a type C USB cable.
...
6. Verification:
 ...
 4.  Run RED.DM.secuasset.bat in the SBOOT folder and provide the path to your input file
 ...
 the OTP of the RA6W2, and this is done as part of the Secure Boot Image provisioning.
 ...
 3.  Connect the RA6W2 MCU motherboard debug port to the host PC via a type C USB cable.
 4.  Debug or flash the EP project to the RA6W2 board.
...
Note:
This example can be tested on both secure & non secure devices.
The RA6W2 must use a Secure Boot image to enable AT Secure Channel, as the Hardware Key
