...
* Description  : provisioning function declarations
...
typedef enum e_provisioning_ap_cmd_type
{
    ...
    SET_STA_SSID_PW,                    ///< Set STA SSID and Password
...
{
    P_TYPE_SLEEP_MODE = 0,                ///< Sleep mode
    P_TYPE_USE_DPM,                       ///< Use DPM or Not
    P_TYPE_RTC_TIME,                      ///< RTC Time
    P_TYPE_DPM_KEEP_ALIVE,                ///< DPM Keep Alive
    P_TYPE_USER_WAKE_UP,                  ///< User Wake Up Time
    P_TYPE_TIM_WAKE_UP,                   ///< Timer Wake Up Time
