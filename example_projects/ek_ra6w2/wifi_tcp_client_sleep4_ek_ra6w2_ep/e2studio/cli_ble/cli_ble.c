...
extern bool cmd_ble_hibernate_enable(int argc, char *argv[]);
extern bool cmd_ble_hibernate_disable(int argc, char *argv[]);
...
static const debug_handler_t ble_handlers[] = {
    ...
    { "ble_hibernate_enable",  "BLE hibernate enable",                (debug_callback_t)cmd_ble_hibernate_enable          },
    { "ble_hibernate_disable", "BLE hibernate disable",               (debug_callback_t)cmd_ble_hibernate_disable         },
    { NULL },
};
