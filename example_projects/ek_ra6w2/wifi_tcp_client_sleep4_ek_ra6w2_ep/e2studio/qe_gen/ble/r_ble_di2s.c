...
***********************************************************************************************************************/
/***********************************************************************************************************************
 * File Name: r_ble_di2s.c
 * Version : 1.0
 * Description : The source file for Device Information Service2 service.
 **********************************************************************************************************************/
...
static const st_ble_servs_char_info_t gs_mfr_name_char = {
    .start_hdl    = BLE_DI2S_MFR_NAME_DECL_HDL,
    .end_hdl      = BLE_DI2S_MFR_NAME_VAL_HDL,
    .char_idx     = BLE_DI2S_MFR_NAME_IDX,
    .app_size     = sizeof(st_ble_seq_data_t),
    .db_size      = BLE_DI2S_MFR_NAME_LEN,
...
static const st_ble_servs_char_info_t gs_model_num_char = {
    .start_hdl    = BLE_DI2S_MODEL_NUM_DECL_HDL,
    .end_hdl      = BLE_DI2S_MODEL_NUM_VAL_HDL,
    .char_idx     = BLE_DI2S_MODEL_NUM_IDX,
    .app_size     = sizeof(st_ble_seq_data_t),
    .db_size      = BLE_DI2S_MODEL_NUM_LEN,
    .decode       = (ble_servs_attr_decode_t)decode_st_ble_seq_data_t,
    .encode       = (ble_servs_attr_encode_t)encode_st_ble_seq_data_t,
};
...
static const st_ble_servs_char_info_t gs_ser_num_char = {
    .start_hdl    = BLE_DI2S_SER_NUM_DECL_HDL,
    .end_hdl      = BLE_DI2S_SER_NUM_VAL_HDL,
    .char_idx     = BLE_DI2S_SER_NUM_IDX,
    .app_size     = sizeof(st_ble_seq_data_t),
    .db_size      = BLE_DI2S_SER_NUM_LEN,
    .decode       = (ble_servs_attr_decode_t)decode_st_ble_seq_data_t,
    .encode       = (ble_servs_attr_encode_t)encode_st_ble_seq_data_t,
};
...
static const st_ble_servs_char_info_t gs_hw_rev_char = {
    .start_hdl    = BLE_DI2S_HW_REV_DECL_HDL,
    .end_hdl      = BLE_DI2S_HW_REV_VAL_HDL,
    .char_idx     = BLE_DI2S_HW_REV_IDX,
    .app_size     = sizeof(st_ble_seq_data_t),
    .db_size      = BLE_DI2S_HW_REV_LEN,
    .decode       = (ble_servs_attr_decode_t)decode_st_ble_seq_data_t,
    .encode       = (ble_servs_attr_encode_t)encode_st_ble_seq_data_t,
};
...
static const st_ble_servs_char_info_t gs_firm_rev_char = {
    .start_hdl    = BLE_DI2S_FIRM_REV_DECL_HDL,
    .end_hdl      = BLE_DI2S_FIRM_REV_VAL_HDL,
    .char_idx     = BLE_DI2S_FIRM_REV_IDX,
    .app_size     = sizeof(st_ble_seq_data_t),
    .db_size      = BLE_DI2S_FIRM_REV_LEN,
    .decode       = (ble_servs_attr_decode_t)decode_st_ble_seq_data_t,
    .encode       = (ble_servs_attr_encode_t)encode_st_ble_seq_data_t,
};
...
static const st_ble_servs_char_info_t gs_sw_rev_char = {
    .start_hdl    = BLE_DI2S_SW_REV_DECL_HDL,
    .end_hdl      = BLE_DI2S_SW_REV_VAL_HDL,
    .char_idx     = BLE_DI2S_SW_REV_IDX,
    .app_size     = sizeof(st_ble_seq_data_t),
    .db_size      = BLE_DI2S_SW_REV_LEN,
    .decode       = (ble_servs_attr_decode_t)decode_st_ble_seq_data_t,
    .encode       = (ble_servs_attr_encode_t)encode_st_ble_seq_data_t,
};
...
static ble_status_t decode_st_ble_di2s_sys_id_t(st_ble_di2s_sys_id_t *p_app_value, const st_ble_gatt_value_t *p_gatt_value)
{
...
static ble_status_t encode_st_ble_di2s_sys_id_t(const st_ble_di2s_sys_id_t *p_app_value, st_ble_gatt_value_t *p_gatt_value)
{
...
static const st_ble_servs_char_info_t gs_sys_id_char = {
    .start_hdl    = BLE_DI2S_SYS_ID_DECL_HDL,
    .end_hdl      = BLE_DI2S_SYS_ID_VAL_HDL,
    .char_idx     = BLE_DI2S_SYS_ID_IDX,
    .app_size     = sizeof(st_ble_di2s_sys_id_t),
    .db_size      = BLE_DI2S_SYS_ID_LEN,
    .decode       = (ble_servs_attr_decode_t)decode_st_ble_di2s_sys_id_t,
    .encode       = (ble_servs_attr_encode_t)encode_st_ble_di2s_sys_id_t,
};
...
static const st_ble_servs_char_info_t gs_reg_cer_data_list_char = {
    .start_hdl    = BLE_DI2S_REG_CER_DATA_LIST_DECL_HDL,
    .end_hdl      = BLE_DI2S_REG_CER_DATA_LIST_VAL_HDL,
    .char_idx     = BLE_DI2S_REG_CER_DATA_LIST_IDX,
    .app_size     = sizeof(st_ble_seq_data_t),
    .db_size      = BLE_DI2S_REG_CER_DATA_LIST_LEN,
    .decode       = (ble_servs_attr_decode_t)decode_st_ble_seq_data_t,
    .encode       = (ble_servs_attr_encode_t)encode_st_ble_seq_data_t,
};
...
static ble_status_t decode_st_ble_di2s_pnp_id_t(st_ble_di2s_pnp_id_t *p_app_value, const st_ble_gatt_value_t *p_gatt_value)
{
...
static ble_status_t encode_st_ble_di2s_pnp_id_t(const st_ble_di2s_pnp_id_t *p_app_value, st_ble_gatt_value_t *p_gatt_value)
{
...
static const st_ble_servs_char_info_t gs_pnp_id_char = {
    .start_hdl    = BLE_DI2S_PNP_ID_DECL_HDL,
    .end_hdl      = BLE_DI2S_PNP_ID_VAL_HDL,
    .char_idx     = BLE_DI2S_PNP_ID_IDX,
    .app_size     = sizeof(st_ble_di2s_pnp_id_t),
    .db_size      = BLE_DI2S_PNP_ID_LEN,
    .decode       = (ble_servs_attr_decode_t)decode_st_ble_di2s_pnp_id_t,
    .encode       = (ble_servs_attr_encode_t)encode_st_ble_di2s_pnp_id_t,
};
...
/*----------------------------------------------------------------------------------------------------------------------
    Device Information Service2 server
----------------------------------------------------------------------------------------------------------------------*/

/* Device Information Service2 characteristics definition */
...
/* Device Information Service2 service definition */
static st_ble_servs_info_t gs_servs_info = {
    .pp_chars     = gspp_chars,
