...
The wifi_twt_ek_ra6w2_ep is a basic TWT application. After connecting to access point, it initiates a TWT session negotiation with defined wake intervals and durations.
