...
1. Project Overview:
This project demonstrates how to securely store and retrieve sensitive application 
data such as Wi-Fi credentials and attestation keys using the CC312 Security Library
