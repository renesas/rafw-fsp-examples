...
#define BTN_PROV_MODE          (IOPORT_CFG_PULLUP_ENABLE | IOPORT_CFG_RETENTION)
...
static void provision_app_gpio_event_task(void *param)
{
    ...
    while (pdTRUE)
    {
        ...
        {
            ext_irq_w_extended_cfg_t const * p_irq1_ext_cfg =
                (ext_irq_w_extended_cfg_t const *) g_external_irq1.p_cfg->p_extend;
