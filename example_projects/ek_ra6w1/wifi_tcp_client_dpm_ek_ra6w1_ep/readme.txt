...
The wifi_tcp_client_dpm_ek_ra6w1_ep application acts as a TCP client in DPM mode and 
...
which wakes up the RA6W1 every 10000 ms. The TCP client then sends a packet
