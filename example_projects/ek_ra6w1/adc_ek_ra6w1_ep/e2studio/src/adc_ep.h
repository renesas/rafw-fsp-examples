...
// Maximum digital value for a 12-bit ADC (2^12)
#define ADC_12_BIT (4096u)

// Maximum digital value for a 16-bit ADC (2^15 for signed or 2^16 for unsigned depending on use case)
#define ADC_16_BIT (32768u)

// Reference voltage applied to the ADC
#define V_ref (1.4f)

// Upper ADC threshold limit
#define ADC_H_LMT (3103u)

// Lower ADC threshold limit
...
#define BANNER_7    "\r\nThe project initializes the ADC in single scan or continuous scan mode \
                     \r\nbased on user selection in RRQ configurator.Once initialized,user can start \
