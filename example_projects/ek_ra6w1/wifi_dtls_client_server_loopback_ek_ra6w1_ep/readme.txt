...
authentication on the Renesas RA6W1 platform.

The project establishes a secure DTLS connection over UDP between the RA6W1 embedded client
...
4) Wait for the RA6W1 DTLS client to connect.
