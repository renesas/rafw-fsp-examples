...
6. Verifying Operation:
 ...
 2.Connect the RA6W1 board to your host PC using a USB Type-C cable.
 3.Open Segger RTT Viewer for logging.
 4.Build and flash the example project to the RA6W1 board.
 ...
 7.Verify that the client receives messages echoed back from the server – you can see this in the console as:
   [INFO] TLS Server: Received data from Client: Hello from TLS Server!
