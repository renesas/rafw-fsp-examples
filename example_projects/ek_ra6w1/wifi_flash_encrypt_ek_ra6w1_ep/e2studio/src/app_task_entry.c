 ...
 * Description  : Flash Encryption, CC312 + USER AREA encryption.
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
#define EP_APP_DESCRIPTION \
    "This example demonstrates how to encrypt and decrypt data in flash memory using the CC312 Security Library."
