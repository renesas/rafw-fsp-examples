...
void app_task_entry(void *pvParameters)
{
    ...
    /* Run OTP Read Example Demonstration */
    otp_example_result_t otp_result = otp_example_run_read_demo();

    if (otp_result == OTP_EXAMPLE_SUCCESS)
    {
        /* OTP read operations completed successfully */
    }
    else
    {
