...
Ensure the host PC running XAMPP and the RA6W1 board are connected to the same Wi-Fi network.
...
The OTA firmware image must be hosted on an HTTP server accessible by the RA6W1 board.
