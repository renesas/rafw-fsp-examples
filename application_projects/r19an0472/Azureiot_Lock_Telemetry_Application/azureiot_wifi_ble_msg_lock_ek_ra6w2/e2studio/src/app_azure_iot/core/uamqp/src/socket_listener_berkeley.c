...
#include <sys/types.h>
//#include <sys/socket.h> //AZURE_CHANGES
#include <stdlib.h>
#include <fcntl.h>
#if 0  //AZURE_CHANGES
...
#endif //AZURE_CHANGES
#include "lwip/sockets.h" //AZURE_CHANGES
#include <unistd.h>
...
int socketlistener_start(SOCKET_LISTENER_HANDLE socket_listener, ON_SOCKET_ACCEPTED on_socket_accepted, void* callback_context)
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
//azurefrtoswork[[: from atcmd_tcp_server.c
				if (listen(socket_listener_instance->socket, 4) == -1)
//]]
                {
