...
#include "azure_c_shared_utility/tlsio_mbedtls.h" //AZURE_CHANGES azurefrtoswork
...
int platform_init(void)
{
   ...
   // ThreadAPI_Sleep(10000); //AZURE_CHANGES
    return 0;
}

const IO_INTERFACE_DESCRIPTION* platform_get_default_tlsio(void)
{
	return tlsio_mbedtls_get_interface_description(); //AZURE_CHANGES azurefrtoswork
}
