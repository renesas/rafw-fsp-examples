...
{
	// printf("\n****api_test****IoTHubMessage_CreateFromByteArray****\n");
...
{
    // printf("\n***api_test***IoTHubMessage_CreateFromString****\n");
    IOTHUB_MESSAGE_HANDLE_DATA* result;
    if (source == NULL)
    {
        LogError("Invalid argument - source is NULL");
...
{
	// printf("\n*****api_test****IoTHubMessage_Properties\n");
    MAP_HANDLE result;
    if (iotHubMessageHandle == NULL)
    {
...
{
	// printf("\n****api_test****IoTHubMessage_SetCorrelationId****\n");
    IOTHUB_MESSAGE_RESULT result;
...
{
	// printf("\n****api_test****IoTHubMessage_SetMessageId****\n");
    IOTHUB_MESSAGE_RESULT result;
...
{
	// printf("\n****api_test******IoTHubMessage_SetContentTypeSystemProperty***\n");
    IOTHUB_MESSAGE_RESULT result;
...
{
	// printf("\n****api_test****IoTHubMessage_SetContentEncodingSystemProperty****\n");
    IOTHUB_MESSAGE_RESULT result;
...
{
	// printf("\n****api_test****IoTHubMessage_SetConnectionDeviceId*****\n");
    IOTHUB_MESSAGE_RESULT result;
...
{
	// printf("\n***api_test***IoTHubMessage_Destroy***\n");
    if (iotHubMessageHandle != NULL)
    {
