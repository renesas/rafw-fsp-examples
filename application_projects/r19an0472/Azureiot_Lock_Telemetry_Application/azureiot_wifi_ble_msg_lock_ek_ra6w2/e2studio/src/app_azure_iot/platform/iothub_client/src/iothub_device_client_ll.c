...
{
    // printf("\n***api_test***IoTHubDeviceClient_LL_CreateFromConnectionString*****\n");
...
{
	// printf("\n****api_test****IoTHubDeviceClient_LL_SendEventAsync****\n");
...
{
    // printf("\n***api_test***IoTHubDeviceClient_LL_SendReportedState***\n");
