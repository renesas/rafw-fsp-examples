...
typedef enum
{
    ...
    BLE_GAPC_EVENT_PER_PREF_CONN_PARAM_READ_RSP = BLE_SERVC_ATTR_EVENT(BLE_GAPC_PER_PREF_CONN_PARAM_IDX,
                                                                       BLE_SERVC_READ_RSP),
    ...
    BLE_GAPC_EVENT_RSLV_PRIV_ADDR_ONLY_READ_RSP = BLE_SERVC_ATTR_EVENT(BLE_GAPC_RSLV_PRIV_ADDR_ONLY_IDX,
                                                                       BLE_SERVC_READ_RSP),
} e_ble_gapc_event_t;
