 ...
 */
 #define BLE_SERVC_MULTI_ATTR_EVENT(attr_idx, inst_idx, \
                                    evt_idx)        ((uint16_t) ((attr_idx << 10) | (inst_idx << 6) | (evt_idx << 0)))
 ...
 ***********************************************************************************************************************/
typedef void (* ble_servc_attr_read_rsp_t)(const void * p_attr, uint16_t conn_hdl, ble_status_t result,
 ...
 * @return  See @ref ble_status_t
 **********************************************************************************************************************/
ble_status_t R_BLE_SERVC_WriteDesc2(const st_ble_servc_desc_info_t * p_attr, uint16_t conn_hdl,
                                    const void * p_app_value);
