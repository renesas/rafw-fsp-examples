 ...
 */
 #define BLE_SERVS_MULTI_ATTR_EVENT(attr_idx, inst_idx, \
 ...
 ***********************************************************************************************************************/
typedef void (* ble_servs_attr_write_req_t)(const void * p_attr, uint16_t conn_hdl, ble_status_t result,
 ...
 ***********************************************************************************************************************/
typedef void (* ble_servs_attr_write_cmd_t)(const void * p_attr, uint16_t conn_hdl, ble_status_t result,
                                            const void * p_app_value);
 ...
 ***********************************************************************************************************************/
typedef void (* ble_servs_attr_write_comp_t)(const void * p_attr, uint16_t conn_hdl, ble_status_t result,
                                             const void * p_app_value);
