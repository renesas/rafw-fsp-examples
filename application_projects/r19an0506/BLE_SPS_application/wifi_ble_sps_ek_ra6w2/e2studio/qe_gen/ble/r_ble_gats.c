...
static ble_status_t decode_st_ble_gats_serv_chged_t (st_ble_gats_serv_chged_t  * p_app_value,
...
static ble_status_t encode_st_ble_gats_serv_chged_t (const st_ble_gats_serv_chged_t * p_app_value,
