 ...
 * Version : 1.0
 * Description : The header file for GAP Service service.
 **********************************************************************************************************************/
...
/*******************************************************************************************************************//**
 * @file
 * @defgroup gaps GAP Service Service
 * @{
 * @ingroup profile
 ...
 *******************************************************************************/
ble_status_t R_BLE_GAPS_SetDevName(const uint8_t * p_value);
 ...
 * @return    @ref ble_status_t
 *******************************************************************************/
ble_status_t R_BLE_GAPS_GetDevName(uint8_t * p_value);
...
typedef enum
{
    ...
    BLE_GAPS_EVENT_PER_PREF_CONN_PARAM_READ_REQ = BLE_SERVS_ATTR_EVENT(BLE_GAPS_PER_PREF_CONN_PARAM_IDX,
                                                                       BLE_SERVS_READ_REQ),
    ...
    BLE_GAPS_EVENT_RSLV_PRIV_ADDR_ONLY_READ_REQ = BLE_SERVS_ATTR_EVENT(BLE_GAPS_RSLV_PRIV_ADDR_ONLY_IDX,
                                                                       BLE_SERVS_READ_REQ),
} e_ble_gaps_event_t;

/***************************************************************************//**
 * @brief     Initialize GAP Service service.
