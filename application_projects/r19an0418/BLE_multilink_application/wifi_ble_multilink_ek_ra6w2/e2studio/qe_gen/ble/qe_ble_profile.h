...
typedef enum qe_attribute_handle
{
	...
	QE_ATTRIBUTE_HANDLE_SERVICE_DECL_MLS,
	QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_MLS_PERIPH_ADDR,
	QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_MLS_PERIPH_ADDR,
...
#define		QE_BLE_PROFILE_NUMBER_OF_ATTRIBUTES	(0x0013)
