...
static ble_status_t decode_st_ble_mlss_periph_addr_t (st_ble_mlss_periph_addr_t * p_app_value,
...
static ble_status_t encode_st_ble_mlss_periph_addr_t (const st_ble_mlss_periph_addr_t * p_app_value,
