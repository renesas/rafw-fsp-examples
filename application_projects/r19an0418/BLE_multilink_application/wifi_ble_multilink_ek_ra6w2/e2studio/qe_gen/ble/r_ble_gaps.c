 ...
 * Version : 1.0
 * Description : The source file for GAP Service service.
 **********************************************************************************************************************/
...
static ble_status_t decode_st_ble_gaps_dev_name_t (st_ble_gaps_dev_name_t    * p_app_value,
                                                   const st_ble_gatt_value_t * p_gatt_value)
{
    ...
    if (BLE_GAPS_DEV_NAME_LEN - 1 < p_gatt_value->value_len)
    {
        return BLE_ERR_INVALID_DATA;
    }

    memset(p_app_value->name, 0x00, BLE_GAPS_DEV_NAME_LEN - 1);
...
static ble_status_t encode_st_ble_gaps_dev_name_t (const st_ble_gaps_dev_name_t * p_app_value,
                                                   st_ble_gatt_value_t          * p_gatt_value)
{
    ...
    if (BLE_GAPS_DEV_NAME_LEN < p_app_value->length)
    {
        return BLE_ERR_INVALID_DATA;
    }
...
static ble_status_t decode_st_ble_gaps_per_pref_conn_param_t (st_ble_gaps_per_pref_conn_param_t * p_app_value,
                                                              const st_ble_gatt_value_t         * p_gatt_value)
{
...
static ble_status_t encode_st_ble_gaps_per_pref_conn_param_t (const st_ble_gaps_per_pref_conn_param_t * p_app_value,
                                                              st_ble_gatt_value_t                     * p_gatt_value)
{
...
/* GAP Service service definition */
static st_ble_servs_info_t gs_servs_info =
{
    .pp_chars     = gspp_chars,
