...
/* Device Name characteristic 128 bit UUID */
...
static ble_status_t decode_st_ble_gapc_dev_name_t (st_ble_gapc_dev_name_t    * p_app_value,
                                                   const st_ble_gatt_value_t * p_gatt_value)
{
    ...
    if (BLE_GAPC_DEV_NAME_LEN - 1 < p_gatt_value->value_len)
    {
        return BLE_ERR_INVALID_DATA;
    }

    memset(p_app_value->name, 0x00, BLE_GAPC_DEV_NAME_LEN - 1);
...
static ble_status_t encode_st_ble_gapc_dev_name_t (const st_ble_gapc_dev_name_t * p_app_value,
...
/* Appearance characteristic 128 bit UUID */
...
/* Peripheral Preferred Connection Parameters characteristic 128 bit UUID */
...
static ble_status_t decode_st_ble_gapc_per_pref_conn_param_t (st_ble_gapc_per_pref_conn_param_t * p_app_value,
                                                              const st_ble_gatt_value_t         * p_gatt_value)
{
...
static ble_status_t encode_st_ble_gapc_per_pref_conn_param_t (const st_ble_gapc_per_pref_conn_param_t * p_app_value,
                                                              st_ble_gatt_value_t                     * p_gatt_value)
{
...
/* Central Address Resolution characteristic 128 bit UUID */
...
/* Resolvable Private Address Only characteristic 128 bit UUID */
