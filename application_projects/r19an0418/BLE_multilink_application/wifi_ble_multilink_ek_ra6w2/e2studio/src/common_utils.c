...
#define BANNER_1    "******************************************************************\n\r"
#define BANNER_2    "*   Renesas RAFW (FSP) Application Project for %s Module\n\r"
#define BANNER_3    "*   Application Project Version %s\n\r"
#define BANNER_4    "*   Renesas RAFW (FSP): Version  %d.%d.%d\n\r"
#define BANNER_5    "******************************************************************\n\r"
#define BANNER_6    "Overview:\n\r%s\n\r"
#define BANNER_7    "Refer to readme.txt file for more details on Multi-Link Application Project and\n\r" \
...
void print_ep_info_banner (const char * s_module, const char * s_version, const char * s_info)
{
    ...
    APP_PRINT_INFO(BANNER_4, version.version_id_b.major, version.version_id_b.minor, version.version_id_b.patch);
