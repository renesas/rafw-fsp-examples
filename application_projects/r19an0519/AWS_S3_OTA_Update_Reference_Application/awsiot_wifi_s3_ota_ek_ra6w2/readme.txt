...
5. Verification:
 ...
 10. Write the S3 Bucket URL (ota_url) and OTA flag (ota_flag) into the NVRAM using cli commands:
     ...
     - nvram setenv appcfg ota_url <URL> (url for demo is aws-s3-ota-bucket.s3.ap-northeast-2.amazonaws.com)
 ...
 13. After connection to AP is successfull, RA6W2 will check for the OTA flag is set ready and OTA url is available.
     If it is available, then RA6W2 will start the OTA update demo and start to download the image file from the S3 bucket.
