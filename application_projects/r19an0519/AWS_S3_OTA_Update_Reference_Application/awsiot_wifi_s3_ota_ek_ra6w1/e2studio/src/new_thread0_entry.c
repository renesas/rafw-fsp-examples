...
static void app_task_start()
{
    xTaskCreate(aws_s3_ota_app_start,
...
static bool execute_WIFI_profile()
{
...
#include "rm_wifi.h"
    ...
    {
        printf("Please Configure WiFi Access Point details,"
               "OTA url and OTA flag(1) in nvram (appcfg). Then reboot.\n");
        printf("Loading easy setup task for configuring WiFi Access Point details\n");
#if CFG_CLI
