...
7. Verifying Operation:
    ...
    11. The RA6W1 device establishes a secure WebSocket (WSS) connection to the configured server.
       Once the WebSocket is up, it connects to the MQTT broker (Client ID: RA6W1_WS) and:
