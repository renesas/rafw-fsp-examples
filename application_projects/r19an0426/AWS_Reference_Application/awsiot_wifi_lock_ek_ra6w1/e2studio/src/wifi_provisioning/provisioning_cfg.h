 ...
 * Description  : PROVISIONING_W_APP_CONFIG Build Time Configurations
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
#ifndef AWS_PROVISIONING_TEST_ENABLE
#define AWS_PROVISIONING_TEST_ENABLE                (1)
#endif

#if 1 == AWS_PROVISIONING_TEST_ENABLE
 #include "rm_awsiot_w_cfg.h"
 #define PROVISIONING_APP_THING_NAME AWS_IOT_THING_NAME
#else
