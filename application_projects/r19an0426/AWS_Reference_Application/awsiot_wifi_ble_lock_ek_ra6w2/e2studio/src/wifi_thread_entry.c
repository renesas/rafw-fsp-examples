 ...
 * Description  : Entry file for the thread, WIFI Thread
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
void wifi_thread_entry(void *pvParameters)
{
    ...
    sem_err = xSemaphoreGive(g_sys_init_semaphore);
    ...
    {
        p_instance_ctrl->ram_counter_cause[PMGR_DBG_RAM_CONSTRAINT_PMGR_OPEN_CALLER]--;
    }
 #endif
#endif //CFG_PMGR
#endif
