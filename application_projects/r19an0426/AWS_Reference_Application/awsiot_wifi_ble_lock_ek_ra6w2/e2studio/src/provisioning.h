 ...
 * Description  : Header file for data structures, interfaces used for provisioning and WiFi network configuration.
 ***********************************************************************************************************************/
/***********************************************************************************************************************
...
typedef struct
{
  ...
  int (*wifi_connect)(const prov_cmd_select_ap_t *params);
