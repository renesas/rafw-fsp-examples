...
8. Verifying Operation:
   ...
   10. The RA6W2 device establishes a secure WebSocket (WSS) connection to the configured server,
       sends periodic "Hello from RA6W2" text messages every 5 seconds, and prints any data
   ...
   SEGGER RTT Viewer. The RA6W2 console (Tera Term) does not display the connection status.
