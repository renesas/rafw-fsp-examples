...
*              : 09/11/2024 1.01    Add Read Indication Flag
***********************************************************************************************************************/
...
typedef enum qe_attribute_handle
{
    ...
    QE_ATTRIBUTE_HANDLE_SERVICE_DECL_WIFIPROVISIONING,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_WIFIPROVISIONING_WIFICOMMAND,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_WIFIPROVISIONING_WIFICOMMAND,
    QE_ATTRIBUTE_HANDLE_DESCRIPTOR_WIFIPROVISIONING_WIFICOMMAND_CHAR_USER_DESCRIPTION,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_WIFIPROVISIONING_WIFISTATUS,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_WIFIPROVISIONING_WIFISTATUS,
    QE_ATTRIBUTE_HANDLE_DESCRIPTOR_WIFIPROVISIONING_WIFISTATUS_CLI_CNFG,
    QE_ATTRIBUTE_HANDLE_DESCRIPTOR_WIFIPROVISIONING_WIFISTATUS_CHAR_USER_DESCRIPTION,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_WIFIPROVISIONING_WIFIOUTPUT,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_WIFIPROVISIONING_WIFIOUTPUT,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_WIFIPROVISIONING_WIFIPROVISONING,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_WIFIPROVISIONING_WIFIPROVISONING,
#if defined (__SUPPORT_MATTER_IOT__)
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_MATTER_RX,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_MATTER_RX,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_MATTER_TX,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_MATTER_TX,
    QE_ATTRIBUTE_HANDLE_DESCRIPTOR_MATTER_TX_CNFG,
    QE_ATTRIBUTE_HANDLE_DESCRIPTOR_MATTER_CHAR_USER_DESCRIPTION,
...
#define        QE_BLE_PROFILE_NUMBER_OF_ATTRIBUTES    (0x0022)    //(0x001C)
