...
----------------------------------------------------------------------------------------------------------------------*/
/***************************************************************************//**
 * @brief MAtter RX value structure.
*******************************************************************************/
typedef struct {
...
/***************************************************************************//**
 * @brief     Set Matter RX characteristic value to the local GATT database.
 * @param[in] p_value  Characteristic value to set.
 * @return    @ref ble_status_t
*******************************************************************************/
ble_status_t R_BLE_MATTER_SetRX(
    const st_ble_matter_rx_t *p_value);

/***************************************************************************//**
 * @brief     Get Matter RX characteristic value from the local GATT database.
 * @param[out] p_value  Output location for the acquired descriptor value.
 * @return    @ref ble_status_t
*******************************************************************************/
ble_status_t R_BLE_MATTER_GetRX(
    st_ble_matter_rx_t *p_value);

/*----------------------------------------------------------------------------------------------------------------------
    Matter TX Characteristic
----------------------------------------------------------------------------------------------------------------------*/
/***************************************************************************//**
 * @brief Matter TX value structure.
*******************************************************************************/
typedef struct {
    char value[255]; /**< value */
    uint8_t len;	/**< length */
...
/***************************************************************************//**
 * @brief MAtter TX Characteristic User Descriptor value structure.
*******************************************************************************/
typedef struct {
    char user_description[22]; /**< User Description */
} st_ble_matter_tx_cfg_user_description_t;
/***************************************************************************//**
 * @brief MAtter TX Characteristic User Descriptor value structure.
*******************************************************************************/
typedef struct {
    char user_description[13]; /**< User Description */
} st_ble_matter_tx_char_user_description_t;

/***************************************************************************//**
 * @brief     Set Matter TX char user description descriptor value to the local GATT database.
 * @param[in] p_value  Descriptor value to set.
 * @return    @ref ble_status_t
*******************************************************************************/
ble_status_t R_BLE_MATTER_SetTXCharUserDescription(
    const st_ble_matter_tx_char_user_description_t *p_value);

/***************************************************************************//**
 * @brief     Get Matter TX char user description descriptor value from the local GATT database.
 * @param[out] p_value  Output location for the acquired descriptor value.
 * @return    @ref ble_status_t
*******************************************************************************/
ble_status_t R_BLE_MATTER_GetTXCharUserDescription(
    st_ble_matter_tx_char_user_description_t *p_value);

/***************************************************************************//**
 * @brief     Send indication of  Matter TX characteristic value to the remote device.
 * @param[in] conn_hdl Connection handle.
 * @param[in] p_value  Characteristic value to send.
 * @return    @ref ble_status_t
*******************************************************************************/
ble_status_t R_BLE_MATTER_TX_Indicate(
    uint16_t conn_hdl, const void *p_value, uint16_t p_value_len);

/***************************************************************************//**
 * @brief     Set Matter TX cnfg descriptor value to the local GATT database.
 * @param[in] conn_hdl Connection handle.
 * @param[in] p_value  Descriptor value to set.
 * @return    @ref ble_status_t
*******************************************************************************/
ble_status_t R_BLE_Matter_SetTXCnfg(
    uint16_t conn_hdl, const uint16_t *p_value);

/***************************************************************************//**
 * @brief     Get Matter TX cnfg descriptor value from the local GATT database.
 * @param[in] conn_hdl Connection handle.
 * @param[out] p_value  Output location for the acquired descriptor value.
 * @return    @ref ble_status_t
*******************************************************************************/
ble_status_t R_BLE_Matter_GetTXCnfg(
    uint16_t conn_hdl, uint16_t *p_value);


#endif // __SUPOORT_MATTER_IOT
...
typedef enum {
	...
	BLE_MATTER_RX_IDX,
	BLE_MATTER_TX_IDX,
	BLE_MATTER_TX_CHAR_USER_DESCRIPTION_IDX,
	BLE_MATTER_TX_CNFG_IDX,
    BLE_MATTER_TX_CNFG_USER_DESCRIPTION_IDX,
...
#if defined (__SUPPORT_MATTER_IOT__)
	/* Matter RX */
	BLE_MATTER_EVENT_RX_READ_REQ =
	 BLE_SERVS_ATTR_EVENT(BLE_MATTER_RX_IDX, BLE_SERVS_READ_REQ),
	BLE_MATTER_EVENT_RX_WRITE_REQ =
	 BLE_SERVS_ATTR_EVENT(BLE_MATTER_RX_IDX, BLE_SERVS_WRITE_REQ),
    BLE_MATTER_EVENT_RX_WRITE_COMP =
	 BLE_SERVS_ATTR_EVENT(BLE_MATTER_RX_IDX, BLE_SERVS_WRITE_COMP),

   /* Matter TX */
   BLE_MATTER_EVENT_TX_WRITE_REQ =
	 BLE_SERVS_ATTR_EVENT(BLE_MATTER_TX_IDX, BLE_SERVS_WRITE_REQ),
   BLE_MATTER_EVENT_TX_WRITE_COMP =
	 BLE_SERVS_ATTR_EVENT(BLE_MATTER_TX_IDX, BLE_SERVS_WRITE_COMP),
   BLE_MATTER_EVENT_TX_WRITE_HDL_VAL_CNF =
	 BLE_SERVS_ATTR_EVENT(BLE_MATTER_TX_IDX, BLE_SERVS_HDL_VAL_CNF),
   BLE_MATTER_EVENT_TX_CHAR_USER_DESCRIPTION_WRITE_REQ =
	 BLE_SERVS_ATTR_EVENT(BLE_MATTER_TX_CHAR_USER_DESCRIPTION_IDX, BLE_SERVS_WRITE_REQ),
   BLE_MATTER_EVENT_TX_CHAR_USER_DESCRIPTION_WRITE_COMP =
	 BLE_SERVS_ATTR_EVENT(BLE_MATTER_TX_CHAR_USER_DESCRIPTION_IDX, BLE_SERVS_WRITE_COMP),
   BLE_MATTER_EVENT_TX_CHAR_USER_DESCRIPTION_READ_REQ =
	 BLE_SERVS_ATTR_EVENT(BLE_MATTER_TX_CHAR_USER_DESCRIPTION_IDX, BLE_SERVS_READ_REQ),
   BLE_MATTER_EVENT_TX_CNFG_WRITE_REQ =
	 BLE_SERVS_ATTR_EVENT(BLE_MATTER_TX_CNFG_IDX, BLE_SERVS_WRITE_REQ),
   BLE_MATTER_EVENT_TX_CNFG_WRITE_COMP =
	 BLE_SERVS_ATTR_EVENT(BLE_MATTER_TX_CNFG_IDX, BLE_SERVS_WRITE_COMP),
   BLE_MATTER_EVENT_TX_CNFG_READ_REQ =
	 BLE_SERVS_ATTR_EVENT(BLE_MATTER_TX_CNFG_IDX, BLE_SERVS_READ_REQ),
#endif // __SUPPORT_MATTER_IOT__
