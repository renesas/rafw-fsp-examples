...
CHIP_ERROR RegisterLockEvents()
{
    ...
    static const shell_command_t sDoorlockEventSubCommands[] = { { &EventHelpHandler, "help", "Usage : doorlock event <subcommand>" },
    ...
    static const shell_command_t sDoorlockEventDoorStateSubCommands[] = { { &DoorStateHelpHandler, "help", "Usage : doorlock event door-state-change DoorState" }};
...
{
    static const shell_command_t sCustomSubCommands[] = { { &CustomHelpHandler, "help", "Usage: custom <subcommand>" },
...
CHIP_ERROR ConfigSetPIDHandler(int argc, char **argv)
{
    ...
    arg = strtoull(argv[0], nullptr, 10);
...
{
    static const shell_command_t sConfigSetSubCommands[] = { { &ConfigSetHelpHandler, "help", "Usage : cfgset <subcommand>" },
