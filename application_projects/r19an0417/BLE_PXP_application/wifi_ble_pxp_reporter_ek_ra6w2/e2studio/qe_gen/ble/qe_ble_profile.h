...
typedef enum qe_attribute_handle
{
    ...
    QE_ATTRIBUTE_HANDLE_SERVICE_DECL_IA,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_IA_ALERT_LEVEL,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_IA_ALERT_LEVEL,
    QE_ATTRIBUTE_HANDLE_SERVICE_DECL_LL,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_LL_ALERT_LEVEL,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_LL_ALERT_LEVEL,
    QE_ATTRIBUTE_HANDLE_SERVICE_DECL_TP,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_TP_TX_POWER_LEVEL,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_TP_TX_POWER_LEVEL,
    QE_ATTRIBUTE_HANDLE_SERVICE_DECL_BA,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_BA_BATTERY_LEVEL,
    QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_BA_BATTERY_LEVEL,
    QE_ATTRIBUTE_HANDLE_DESCRIPTOR_BA_BATTERY_LEVEL_CLI_CNFG,
    QE_ATTRIBUTE_HANDLE_DESCRIPTOR_BA_BATTERY_LEVEL_PRESN_FORMAT,
...
#define     QE_BLE_PROFILE_NUMBER_OF_ATTRIBUTES     (0x002D)
