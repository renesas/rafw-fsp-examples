 ...
 * Version : 1.0
 * Description : The source file for Link Loss Service service.
 **********************************************************************************************************************/
...
{
    return R_BLE_SERVS_SetChar(&gs_alert_level_char, BLE_GAP_INVALID_CONN_HDL, (const void *) p_value);
}

ble_status_t R_BLE_LLS_GetAlertLevel (uint8_t * p_value)
{
    return R_BLE_SERVS_GetChar(&gs_alert_level_char, BLE_GAP_INVALID_CONN_HDL, (void *) p_value);
}
...
/* Link Loss Service service definition */
static st_ble_servs_info_t gs_servs_info =
{
    .pp_chars     = gspp_chars,
