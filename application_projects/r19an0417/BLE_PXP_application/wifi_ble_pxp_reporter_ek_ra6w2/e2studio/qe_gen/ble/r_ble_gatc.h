 ...
 * ----------------------------------------------------------------------------------------------------------------------*/
 #define BLE_GATC_SERV_CHGED_UUID             (0x2A05)
 #define BLE_GATC_SERV_CHGED_LEN              (4)
 #define BLE_GATC_SERV_CHGED_CLI_CNFG_UUID    (0x2902)
 #define BLE_GATC_SERV_CHGED_CLI_CNFG_LEN     (2)
...
} st_ble_gatc_serv_chged_attr_hdl_t;
 ...
 *******************************************************************************/
ble_status_t R_BLE_GATC_ReadServChgedCliCnfg(uint16_t conn_hdl);
 ...
 * @return    @ref ble_status_t
 *******************************************************************************/
ble_status_t R_BLE_GATC_WriteServChgedCliCnfg(uint16_t conn_hdl, const uint16_t * p_value);
...
typedef enum
{
    BLE_GATC_SERV_CHGED_IDX,
    BLE_GATC_SERV_CHGED_CLI_CNFG_IDX,
...
{
    /* Service Changed */
    BLE_GATC_EVENT_SERV_CHGED_HDL_VAL_IND       = BLE_SERVC_ATTR_EVENT(BLE_GATC_SERV_CHGED_IDX, BLE_SERVC_HDL_VAL_IND),
    BLE_GATC_EVENT_SERV_CHGED_CLI_CNFG_READ_RSP = BLE_SERVC_ATTR_EVENT(BLE_GATC_SERV_CHGED_CLI_CNFG_IDX,
                                                                       BLE_SERVC_READ_RSP),
    BLE_GATC_EVENT_SERV_CHGED_CLI_CNFG_WRITE_RSP = BLE_SERVC_ATTR_EVENT(BLE_GATC_SERV_CHGED_CLI_CNFG_IDX,
                                                                        BLE_SERVC_WRITE_RSP),
} e_ble_gatc_event_t;
