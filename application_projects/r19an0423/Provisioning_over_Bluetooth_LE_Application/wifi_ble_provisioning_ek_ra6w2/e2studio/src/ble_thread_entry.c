...
#define EP_APP_DESCRIPTION \
    "This example demonstrates Wi-Fi provisioning over BLE.\r" \
    "The device shares available Wi-Fi networks via BLE and connects using credentials from the mobile app."
