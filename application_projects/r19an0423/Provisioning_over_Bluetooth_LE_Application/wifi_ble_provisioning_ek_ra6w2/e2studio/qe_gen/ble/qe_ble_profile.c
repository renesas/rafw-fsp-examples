...
static uint16_t qe_value16[] = {0xF5C1,0x5CDC,0x47B3,0xA3CA,0x4727,0x1B4B,0xB201,0x9161};
...
const attribute_t qe_ble_profile[QE_ATTRIBUTE_HANDLE_PROFILE_END] =
{
	...
	[3] =
	{
		...
		.value = (uint8_t []){},
		.notify_write = 1,
		.notify_read = 0,
		.read_indication = 0,
	...
	// Service Declaration: wifi_provisioning
	[16] =
	{
		.handle = 16,
		.encapsulated_attributes = 12,
		.permissions = 0x61,
		.uuid_length = QE_BLE_PROFILE_UUID_SIZE_ADOPTED,
		.value_length = 0x10,
	...
	// Characteristic Declaration: WiFi Command
	[17] =
	{
		.handle = 17,
		.encapsulated_attributes = 0,
	...
	// Characteristic Value: WiFi Command
	[18] =
	{
		.handle = 18,
		.encapsulated_attributes = 0,
		...
		.value = (uint8_t []){},
		.notify_write = 1,
		.notify_read = 0,
		.read_indication = 0,
	...
	[19] =
	{
		...
		.value = (uint8_t []){0x57,0x69,0x2D,0x46,0x69,0x20,0x43,0x6D,0x64,0x00},
		.notify_write = 1,
		.notify_read = 0,
		.read_indication = 0,
		.p_write_cmd_cb = &(qe_write_cmd_cb_array[19])
	},
	// Characteristic Declaration: WiFi Status
	[20] =
	{
		.handle = 20,
		.encapsulated_attributes = 0,
	...
	// Characteristic Value: WiFi Status
	[21] =
	{
		.handle = 21,
		.encapsulated_attributes = 0,
	...
	[23] =
	{
		...
		.value = (uint8_t []){0x57,0x69,0x2D,0x46,0x69,0x20,0x41,0x63,0x74,0x69,0x6F,0x6E,0x20,0x52,0x65,0x73,0x75,0x6C,0x74,0x00,0x00,0x00},
		.notify_write = 1,
		.notify_read = 0,
		.read_indication = 0,
		.p_write_cmd_cb = &(qe_write_cmd_cb_array[23])
	},
	// Characteristic Declaration: WiFi Output
	[24] =
	{
		.handle = 24,
		.encapsulated_attributes = 0,
		...
		.value = (uint8_t []){0x0B,0x19,0x00,0xC1,0xF5,0xDC,0x5C,0xB3,0x47,0xCA,0xA3,0x27,0x47,0x4B,0x1B,0x04,0xB2,0x61,0x91},
		.notify_write = 1,
		.notify_read = 1,
		.read_indication = 0,
		.p_write_cmd_cb = &(qe_write_cmd_cb_array[24])
	},
	// Characteristic Value: WiFi Output
	[25] =
	{
		.handle = 25,
		.encapsulated_attributes = 0,
	...
	// Characteristic Declaration: WiFi Provisioning
	[26] =
	{
		.handle = 26,
		.encapsulated_attributes = 0,
	...
	// Characteristic Value: WiFi Provisioning
	[27] =
	{
		.handle = 27,
		.encapsulated_attributes = 0,
