...
typedef enum qe_attribute_handle
{
	...
	QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_GAT_SERV_CHANGED,
	QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_GAT_SERV_CHANGED,
	QE_ATTRIBUTE_HANDLE_DESCRIPTOR_GAT_SERV_CHANGED_CLI_CNFG,
	QE_ATTRIBUTE_HANDLE_SERVICE_DECL_WIFI_PROVISIONING,
	QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_WIFI_PROVISIONING_WIFI_COMMAND,
	QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_WIFI_PROVISIONING_WIFI_COMMAND,
	QE_ATTRIBUTE_HANDLE_DESCRIPTOR_WIFI_PROVISIONING_WIFI_COMMAND_CHAR_USER_DESCRIPTION,
	QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_WIFI_PROVISIONING_WIFI_STATUS,
	QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_WIFI_PROVISIONING_WIFI_STATUS,
	QE_ATTRIBUTE_HANDLE_DESCRIPTOR_WIFI_PROVISIONING_WIFI_STATUS_CLI_CNFG,
	QE_ATTRIBUTE_HANDLE_DESCRIPTOR_WIFI_PROVISIONING_WIFI_STATUS_CHAR_USER_DESCRIPTION,
	QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_WIFI_PROVISIONING_WIFI_OUTPUT,
	QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_WIFI_PROVISIONING_WIFI_OUTPUT,
	QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_WIFI_PROVISIONING_WIFI_PROVISIONING,
	QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_WIFI_PROVISIONING_WIFI_PROVISIONING,
...
#define		QE_BLE_PROFILE_NUMBER_OF_ATTRIBUTES	(0x001C)
