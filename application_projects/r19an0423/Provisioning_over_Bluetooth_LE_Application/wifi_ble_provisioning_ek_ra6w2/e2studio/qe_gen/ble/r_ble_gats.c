...
static const st_ble_servs_desc_info_t gs_serv_changed_cli_cnfg = {
    .attr_hdl = BLE_GATS_SERV_CHANGED_CLI_CNFG_DESC_HDL,
    .app_size = sizeof(uint16_t),
    .desc_idx = BLE_GATS_SERV_CHANGED_CLI_CNFG_IDX,
    .db_size  = BLE_GATS_SERV_CHANGED_CLI_CNFG_LEN,
...
static ble_status_t decode_st_ble_gats_serv_changed_t(st_ble_gats_serv_changed_t *p_app_value, const st_ble_gatt_value_t *p_gatt_value)
{
    ...
    if (p_gatt_value->value_len < BLE_GATS_SERV_CHANGED_LEN)
    {
...
static const st_ble_servs_char_info_t gs_serv_changed_char = {
    .start_hdl    = BLE_GATS_SERV_CHANGED_DECL_HDL,
    .end_hdl      = BLE_GATS_SERV_CHANGED_CLI_CNFG_DESC_HDL,
    .char_idx     = BLE_GATS_SERV_CHANGED_IDX,
    .app_size     = sizeof(st_ble_gats_serv_changed_t),
    .db_size      = BLE_GATS_SERV_CHANGED_LEN,
