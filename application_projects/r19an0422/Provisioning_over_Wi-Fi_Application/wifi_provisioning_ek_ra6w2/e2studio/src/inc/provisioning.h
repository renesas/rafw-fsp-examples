 ...
 * Description  : Header file for provisioning functions and threads
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
{
    PROV_TYPE_SLEEP_MODE = 0,                ///< Sleep mode
    PROV_TYPE_USE_DPM,                       ///< Use DPM or Not
    PROV_TYPE_RTC_TIME,                      ///< RTC Time
    PROV_TYPE_DPM_KEEP_ALIVE,                ///< DPM Keep Alive
    PROV_TYPE_USER_WAKE_UP,                  ///< User Wake Up Time
    PROV_TYPE_TIM_WAKE_UP,                   ///< Timer Wake Up Time
...
fsp_err_t provisioning_RebootAPMode(long const ap_mode_flag, long const security_mode_flag,
...
fsp_err_t provisioning_Scan(int32_t option, provisioning_type_t provisioning_mode);
fsp_err_t provisioning_Ping(char *p_ip_address);
fsp_err_t provisioning_NotifyConnectionOnConcurrent(int concurrent_status,char *p_buf);
fsp_err_t provisioning_reboot_ap_mode(long const ap_mode_flag,long const security_mode_flag,
                                      long const factory_reset_flag);
