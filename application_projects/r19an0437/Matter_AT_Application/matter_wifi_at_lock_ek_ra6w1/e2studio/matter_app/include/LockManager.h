...
using namespace RenesDoorLock::ResourceRanges;
...
public:
    ...
    CHIP_ERROR Init(chip::app::DataModel::Nullable<chip::app::Clusters::DoorLock::DlLockState> state,
                    RenesDoorLock::LockInitParams::LockParam lockParam);
...
private:
    ...
    RenesDoorLock::LockInitParams::LockParam LockParams;
};
